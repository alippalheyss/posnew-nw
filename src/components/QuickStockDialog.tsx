      ...
      <DialogContent className="sm:max-w-[800px] h-[80vh] flex flex-col font-faruma bg-[#0a0a1a] border-white/10 text-white shadow-2xl" dir="rtl">
        ...
        <div className="flex-1 overflow-hidden flex flex-col gap-4 py-4">
          ...
          <div className="flex-1 bg-white/5 rounded-2xl border border-white/10 overflow-hidden flex flex-col">
            <div className="grid grid-cols-[1fr_120px_120px_60px] gap-4 p-4 border-b border-white/10 bg-white/5 font-black text-[10px] text-white/40 uppercase tracking-widest text-right">
              <div>Product</div>
              ...
              <div className="p-2 space-y-2">
                {selectedItems.length === 0 ? (
                  ...
                  selectedItems.map(item => (
                    <div key={item.product.id} className="grid grid-cols-[1fr_120px_120px_60px] gap-4 p-3 bg-white/5 rounded-xl items-center transition-all hover:bg-white/10">
