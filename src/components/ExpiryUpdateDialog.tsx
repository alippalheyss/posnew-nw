      ...
      <DialogContent className="sm:max-w-[800px] h-[80vh] flex flex-col font-faruma bg-card border-border text-foreground shadow-2xl" dir="rtl">
        ...
        <div className="flex-1 overflow-hidden flex flex-col gap-4 py-4">
          ...
          <div className="flex-1 bg-muted rounded-2xl border border-border overflow-hidden flex flex-col">
            <div className="grid grid-cols-[1fr_200px_60px] gap-4 p-4 border-b border-border bg-muted font-black text-[10px] text-muted-foreground uppercase tracking-widest text-right">
              <div>Product</div>
              ...
              <div className="p-2 space-y-2">
                {selectedItems.length === 0 ? (
                  ...
                  selectedItems.map(item => (
                    <div key={item.product.id} className="grid grid-cols-[1fr_200px_60px] gap-4 p-3 bg-muted rounded-xl items-center transition-all hover:bg-muted/80">
