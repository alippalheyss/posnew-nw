      ...
      <DialogContent className="sm:max-w-[800px] h-[80vh] flex flex-col font-faruma apple-glass-dialog border-white/20 dark:border-white/10 text-foreground shadow-2xl rounded-3xl p-6 sm:p-7" dir="rtl">
        ...
        <div className="flex-1 overflow-hidden flex flex-col gap-4 py-4">
          ...
          <div className="flex-1 bg-white/5 dark:bg-black/20 rounded-3xl border border-white/10 overflow-hidden flex flex-col backdrop-blur-md">
            <div className="grid grid-cols-[1fr_200px_60px] gap-4 p-4 border-b border-white/10 bg-white/5 dark:bg-black/20 font-black text-[10px] text-muted-foreground uppercase tracking-widest text-right">
              <div>Product</div>
              ...
              <div className="p-3 space-y-2">
                {selectedItems.length === 0 ? (
                  ...
                  selectedItems.map(item => (
                    <div key={item.product.id} className="grid grid-cols-[1fr_200px_60px] gap-4 p-3.5 bg-white/5 dark:bg-white/[0.03] border border-white/5 rounded-2xl items-center transition-all hover:bg-white/10">
