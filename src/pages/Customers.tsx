              ...
              {filteredCustomers.map((customer) => (
                <Card key={customer.id} className="cursor-pointer hover:shadow-lg transition-shadow duration-200 text-right">
                  <CardContent className="p-3">
                    ...
                    <p className="text-xs text-black dark:text-white dark:text-black dark:text-white break-words">Code: {customer.code}</p>
                    <p className="text-xs text-black dark:text-white dark:text-black dark:text-white break-words">Phone: {customer.phone}</p>
                    <p className="text-xs text-black dark:text-white dark:text-black dark:text-white break-words">Credit Limit: {settings.shop.currency} {customer.credit_limit.toFixed(2)}</p>
