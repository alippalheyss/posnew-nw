      ...
      <Card className="flex-1 shadow-md border-none overflow-hidden">
        <CardHeader className="bg-white dark:bg-gray-800 border-b p-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <CardTitle className="text-right text-base text-black dark:text-white font-normal">
                    ...
                    <CardContent className="p-3">
                      ...
                      <div className="flex justify-between items-end">
                        <div className="text-left">
                          <p className="text-[10px] text-black dark:text-white uppercase tracking-wider font-bold">Amount Due</p>
